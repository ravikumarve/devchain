  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Join the blockchain developer marketplace</p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.field}>
            ...
            <input value={username} onChange={e => setUsername(e.target.value)} placeholder="ravikumar" required />
          </div>
          <div style={styles.field}>
