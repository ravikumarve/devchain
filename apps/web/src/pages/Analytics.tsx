      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 24 }}>
          ...
          >
            ...
            <p style={{ color: '#55556a', fontSize: 13, marginBottom: 24 }}>
                ...
                return (
                  ...
                  >
                    <div
                      style={{
                        fontSize: 10,
                        color: val > 0 ? '#7C3AED' : 'transparent',
                        fontWeight: 700,
                      }}
                    >
                      ${val.toFixed(0)}
                    ...
                    <div
                      style={{
                        width: '100%',
                        height: `${Math.max(h, val > 0 ? 8 : 4)}%`,
                        background:
                          val > 0 ? 'linear-gradient(180deg, #9F67FF, #7C3AED)' : '#1e1e2e',
                        borderRadius: '4px 4px 0 0',
                        minHeight: 4,
                        transition: 'height 0.8s ease',
                        boxShadow: val > 0 ? '0 0 10px rgba(124,58,237,0.4)' : 'none',
                      }}
                    />
          ...
          >
            ...
            {productRevenue.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '24px 0', color: '#55556a' }}>
                No sales yet
              </div>
            ) : (
                    ...
                    >
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: 14, fontWeight: 800, color: '#7C3AED' }}>
                          ${(prodSales?.revenue || 0).toFixed(2)}
                        </div>
                        <div style={{ fontSize: 11, color: '#55556a' }}>
                          {prodSales?.sales || 0} sales
                        </div>
                      </div>
                    </div>
                  );
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: '#55556a' }}>
                        bought {s.product?.title?.slice(0, 30)}...
                      </div>
                    </div>
                  </div>
